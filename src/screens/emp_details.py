...
class EmployeeDetailsModal(QDialog):
    ...
    def init_ui(self):
        ...
        name_label.setStyleSheet("color: #6b7280; margin-bottom: 5px; border: transparent;")
        name_value = QLabel(self.employee_data.get("name", "sample name"))
        name_value.setFont(QFont("Inter", 16, QFont.Weight.Bold))
        name_value.setStyleSheet("color: #111827; margin-bottom: 15px; border: transparent;")

        position_label = QLabel("Position")
        position_label.setFont(QFont("Inter", 10))
        position_label.setStyleSheet("color: #6b7280; margin-bottom: 5px; border: transparent;")
        ...
        position_value.setStyleSheet("color: #111827; margin-bottom: 20px; border: transparent;")

        dept_label = QLabel("Department")
        dept_label.setFont(QFont("Inter", 10))
        dept_label.setStyleSheet("color: #6b7280; margin-bottom: 5px; border: transparent;")
        dept_value = QLabel(self.employee_data.get("department", "sample department"))
        dept_value.setFont(QFont("Inter", 12))
        dept_value.setStyleSheet("color: #111827; border: transparent;")
